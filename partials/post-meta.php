...
<section class="post-meta">
    ...
    <div class="post-postedin">
        ...
        if ($categories_list || $tags_list) :
            _e('in ', 'blujay');
            if ($categories_list) :
                ?><span class="post-categories"><?php printf(__('%1$s', 'blujay'), $categories_list); ?></span><?php
            endif; ?><?php if ($tags_list) :
    ?><span class="post-tags"><?php printf(__('%1$s', 'blujay'), $tags_list); ?></span><?php
            endif; ?>
        <?php endif; ?>
    </div>
